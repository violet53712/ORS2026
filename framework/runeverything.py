...
setup.create_linear_step_sweep(unit="GHz",name="Sweep1",start_frequency=27,stop_frequency=29,step_size = 0.1, sweep_type= "Interpolating",)

hfss.analyze()

r1 = extraction.extract_results(hfss)
